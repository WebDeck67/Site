    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col items-center justify-center gap-4 lg:flex-row">
        <Card
          ...
          description="Nous définirons les objectifs, la structure et le design. Cette phase permet de poser les bases solides du projet."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description="La phase de développement transforme le plan en code. Nous allons coder et tester chaque fonctionnalité pour garantir un site performant."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="Une fois le site validé, nous le déployons et assurons le suivi pour garantir une mise en ligne réussie."
        >
          <CanvasRevealEffect
            animationSpeed={3}
